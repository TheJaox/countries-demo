...
public class CountriesController {
  ...
  public ResponseEntity<CountryEntity> saveCountry(@RequestBody CountryEntity newCountry) {
	  return new ResponseEntity<CountryEntity>(countriesService.saveCountry(newCountry), HttpStatus.OK);
  }
